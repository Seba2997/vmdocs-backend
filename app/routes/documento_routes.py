...
@router.post(
    ...
    description=(
        ...
        "metadata en PostgreSQL. El usuario queda registrado como quien subió el archivo. "
...
@router.get(
    ...
    description=(
        "Genera una signed URL temporal de Supabase Storage (válida 5 minutos). "
...
@router.patch(
    ...
    summary="Activar / Desactivar documento",
    description=(
...
def toggle_estado_documento(
    ...
    return documento_service.toggle_estado_documento(db, documento_id)
